...
export default function ContactForm() {
  ...
  <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
    ...
    <div className="text-white">
      <h2 className="text-4xl font-bold mb-6">Prestige Properties</h2>
      <p className="text-lg text-slate-300 mb-12">
        Your trusted partner in luxury real estate. Let's find your dream property together.
      </p>
      ...
      <div className="space-y-8">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-slate-400">123 Luxury Avenue, Suite 500<br />New York, NY 10001</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-slate-400">contact@prestigeproperties.com</p>
          </div>
        </div>
