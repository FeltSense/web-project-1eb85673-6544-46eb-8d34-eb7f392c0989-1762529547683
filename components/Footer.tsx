  ...
  <div className="max-w-6xl mx-auto">
    ...
    <div className="grid md:grid-cols-12 gap-8 mb-12">
      ...
      <div className="md:col-span-5">
        <h3 className="text-2xl font-bold mb-4">Prestige Properties</h3>
        <p className="text-gray-300 mb-6 leading-relaxed">
          Your trusted partner in luxury real estate. Discover exceptional properties and personalized service that exceeds expectations.
        </p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex-1">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Browse properties on the go. Get instant notifications for new listings and schedule viewings directly from your phone.
              </p>
              <div className="flex flex-wrap gap-3">
                <a href="#" className="inline-flex items-center px-4 py-2.5 bg-white text-slate-900 rounded-lg hover:bg-gray-100 transition-colors">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
      ...
      <div>
        ...
        <ul className="space-y-2">
          ...
          <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Valuation</a></li>
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Get in Touch</a></li>
